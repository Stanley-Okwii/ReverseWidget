...
class TransplaceTS extends WidgetBase {
    ...
    private updateRendering() {
        if (this.contextObject) {
            ...
            this.ReverseText2 = reverseText(this.StudentData);


            dojoHtml.set(this.domNode, this.ReverseName(this.contextObject.get(this.StudentData) as string));
            this.DisplayText();
        } else {
        }
    }
...
dojoDeclare("widget.TransplaceTS", [WidgetBase], function (Source: any) {
    const result: any = {};
